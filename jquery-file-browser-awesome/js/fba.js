            ...
            $.each(c.items, function(i, a) {
                ...
                if (c.items[i].type == "folder") {
                    ...
                    switch (s) {
						...
						// List download file                        
						case "apk":
							r += '<div class="fba_content"><div class="name"><a href="' + c.items[i].link + 'download' + c.items[i].path + '" target="_blank"><i class="fa fa-android"></i> ' + c.items[i].name + '</a></div><div class="size">' + b + '</div><div class="modif">' + c.items[i].modif + '</div></div>'
							break;
						case "pdf":
							r += '<div class="fba_content"><div class="name"><a href="' + c.items[i].link + 'download' + c.items[i].path + '" target="_blank"><i class="fa fa-pdf-o"></i> ' + c.items[i].name + '</a></div><div class="size">' + b + '</div><div class="modif">' + c.items[i].modif + '</div></div>'
							break;
						default:
                            r += '<div class="fba_content"><div class="name"><a href="' + c.items[i].link + 'download' + c.items[i].path + '" target="_blank"><i class="fa fa-cloud-download"></i> ' + c.items[i].name + '</a></div><div class="size">' + b + '</div><div class="modif">' + c.items[i].modif + '</div></div>'
                    }
                }
            });
            r += "</div>";
